...
const Academics = () => {
  ...
  const methods = [
    ...
    { icon: Users, title: 'Collaborative Learning', desc: 'Group discussions, peer teaching, and team projects' },
    ...
    <Layout>
      ...
      <section className="py-20 bg-background" ref={ref}>
        <div className={`container-school max-w-4xl ${isVisible ? 'animate-reveal-up' : 'opacity-0'}`}>
          ...
          <p className="text-muted-foreground text-lg mb-8 leading-relaxed">Our school follows the CBSE (Central Board of Secondary Education) curriculum, supplemented with additional enrichment programs. The curriculum emphasizes a balanced approach to academic rigor, creative expression, and physical development.</p>
